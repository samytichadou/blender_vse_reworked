...
[("Sequencer",
  ...
  {"items":
   [("sequencer.select_all",
    ...
    ("sequencer.cut",
     {"type": 'K', "value": 'PRESS'},keyconfig_data = \
[("Sequencer",
  {"space_type": 'SEQUENCE_EDITOR', "region_type": 'WINDOW'},
  {"items":
   [("sequencer.select_all",
    ...
    ("sequencer.preview_start_in_current", {"type": 'I', "value": 'PRESS'}, None),
    ("sequencer.preview_end_in_current", {"type": 'O', "value": 'PRESS'}, None),
    ("sequencer.split_extract_left", {"type": 'K', "value": 'PRESS', "ctrl": True}, None),
    ("sequencer.split_extract_right", {"type": 'K', "value": 'PRESS', "alt": True}, None),
    ...
    ("sequencer.zoom_vertical_in", {"type": 'NUMPAD_8', "value": 'PRESS'}, None),
    ("sequencer.delete_lift", {"type": 'DEL', "value": 'PRESS'}, None),
    ("sequencer.delete_lift", {"type": 'X', "value": 'PRESS'}, None),
    ("sequencer.zoom_vertical_out", {"type": 'NUMPAD_2', "value": 'PRESS'}, None),
    ("view2d.zoom_in", {"type": 'NUMPAD_6', "value": 'PRESS'}, None),
    ("view2d.zoom_out", {"type": 'NUMPAD_4', "value": 'PRESS'}, None),
    ("sequencer.split_hard", {"type": 'K', "value": 'PRESS', "shift": True}, None),
    ("sequencer.split_soft", {"type": 'K', "value": 'PRESS'}, None),
