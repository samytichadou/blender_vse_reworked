...
[("View2D",
  ...
  {"items":
   [("view2d.scroller_activate", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("view2d.zoom_border", {"type": 'B', "value": 'PRESS', "ctrl": True}, None),
    ],
   },
  ),
 ("Sequencer",
  ...
  {"items":
   [("sequencer.select_all",
    ...
    ("sequencer.select_box", {"type": 'B', "value": 'PRESS', "shift": True}, None),
    ...
    ("sequencer.match_frame", {"type": 'F', "value": 'PRESS', "ctrl": True, "alt": True}, None),
